...
.coach-card {
  ...
  padding: 24px; margin-bottom: 16px; box-shadow: 0 1px 3px rgba(0,0,0,.04);
}
...
.roadmap-connector { width: 2px; flex: 1; background: #e5e7eb; margin: 4px 0; min-height: 24px; }
...
.news-card { background: #fff; border: 1px solid #e5e7eb; border-radius: 10px; padding: 14px 18px; margin-bottom: 10px; }
...
def inject_css():
    # 주석 제거 후 공백 정규화 → 단일 라인으로 만들어 렌더러 파싱 문제 방지
